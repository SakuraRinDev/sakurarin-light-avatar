...
- MCP: `/api/mcp` exposes an MCP-compatible internal tool registry from `data/mcp-servers.json`; `/api/mcp/manifest` returns a tool manifest, and chat replies include matched `mcp` tool candidates.
